...
long-range propgation operator. We now show mathematically that $K^{-1}$ indeed
does multi-hop propagation of the normalized adjecacny matrix $\hat A$.
...
\begin{algorithm}[H]
    \caption{Apply MPSSM-PCG Preconditioner}
