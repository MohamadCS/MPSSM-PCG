...
depenencies between distant nodes, and uses a local MPNN to learn depenencies
...
signals. For instance, the original IGNN model \cite{guImplicitGraphNeural2021}
finds $X$ such that $X = \sigma(WXA + b)$. They solve it by repeatdly applying
...
$L$ with fixed sparisty pattern. The first layer applies $L^\top$
